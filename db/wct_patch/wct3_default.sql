...
insert into DB_WCT.ROLE_PRIVILEGE (PRV_OID, PRV_CODE, PRV_ROLE_OID, PRV_SCOPE) values (-4,'GRANT_CROSS_AGENCY_USER_ADMIN',0,0);DROP PROCEDURE IF EXISTS DB_WCT.GENERATEINDICATORS;
DELIMITER //
